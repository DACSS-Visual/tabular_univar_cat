...
The x-values in this variable have **order**. That is, there is an increasing level in the values. Whenever we have an ordering, besides *concentration* we can visualize **asymmetry**: if there is bias towards lower or higher values. 
...
# LAB for THURSDAY: From numeric to ordinal
